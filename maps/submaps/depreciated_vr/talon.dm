...
/obj/item/weapon/card/id/synthetic/talon/Initialize()
	. = ..()
	access = list(access_talon, access_talon_bridge, access_talon_medical, access_talon_engineer, access_talon_cargo, access_talon_sec, access_talon_pilot, access_synth) //RS Edit
