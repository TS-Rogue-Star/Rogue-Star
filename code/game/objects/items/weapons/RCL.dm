/obj/item/weapon/rcl
	...
	var/list/colors = possible_cable_coil_colours
...
/obj/item/weapon/rcl/attack_self_secondary(mob/user, modifiers)
	if(current_amount <= 0)
...
/obj/item/weapon/rcl/proc/on_wield(obj/item/source, mob/user)
	active = TRUE

/// triggered on unwield of two handed item
/obj/item/weapon/rcl/proc/on_unwield(obj/item/source, mob/user)
	active = FALSE

/obj/item/weapon/rcl/pickup(mob/to_hook)
	. = ..()
