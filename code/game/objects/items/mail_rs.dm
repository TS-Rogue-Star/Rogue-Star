...
/obj/item/weapon/paper/fluff/junkmail_generic/Initialize()
	...
	info = pick(
		...
		prob(5);"Hello, I noticed you riding in a 2555 Ripley and wondered if you'd be interested in selling. Low mileage mechs sell very well in our current market. Please call the number on the opposite side if you're interested",
