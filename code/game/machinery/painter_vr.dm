/obj/machinery/gear_painter
	name = "Color Mate"
	desc = "A machine to give your apparel a fresh new color!" //RS Edit || Port Virgo PR 15836
	icon = 'icons/obj/vending_vr.dmi'
	icon_state = "colormate"
	density = TRUE
	anchored = TRUE
	var/atom/movable/inserted //RS Add || Port Virgo PR 15836
	...
	var/list/allowed_types = list(
			...
			/obj/item/toy, //RS Add || Port Virgo PR 15836
			/obj/item/weapon/bedsheet/pillow/exercise,	//RS ADD
			/obj/item/weapon/entrepreneur/crystal		//RS ADD
			)
...
/obj/machinery/gear_painter/update_icon()
	...
	else if(inserted) //RS Edit || Port Virgo PR 15836
		icon_state = "colormate_active"
	else
		icon_state = "colormate"

/obj/machinery/gear_painter/Destroy()
	if(inserted) //please i beg you do not drop nulls || RS Edit || Port Virgo PR 15836
		inserted.forceMove(drop_location())
	return ..()

/obj/machinery/gear_painter/attackby(obj/item/I, mob/living/user) //RS Edit Code Block || Port Virgo PR 15836
	if(inserted)
	...
	if(is_type_in_list(I, allowed_types) && !inoperable()) //RS Edit Code Block || Port Virgo PR 15836
...
/obj/machinery/gear_painter/proc/insert_mob(mob/victim, mob/user) //RS Edit Code Block || Port Virgo PR 15836
	if(inserted)
		return
	if(user)
...
/obj/machinery/gear_painter/AllowDrop()  //RS Edit Code Block || Port Virgo PR 15836
	return FALSE

// /obj/machinery/gear_painter/handle_atom_del(atom/movable/AM)  RS Edit Code Block || Port Virgo PR 15836
// 	if(AM == inserted)
// 		inserted = null
// 	return ..()
