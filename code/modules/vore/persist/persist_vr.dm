...
// Saves mob's current custom species, ears, tail, wings and digitigrade legs state to prefs //RS EDIT
// This basically needs to be the reverse of /datum/category_item/player_setup_item/vore/ears/copy_to_mob() ~Leshana
/proc/apply_ears_to_prefs(var/mob/living/carbon/human/character, var/datum/preferences/prefs) // RS EDIT START (Two ports: Part of VS PR #16109 '(fix: BodyDesigner ears, tail and wings option)' & (Port of VS PR#16513 'Adds a second ear slot.'))
	...
	// secondary ears // RS EDIT START (Port of VS PR#16513 'Adds a second ear slot.')
	prefs.ear_secondary_style = character.ear_secondary_style?.name
	prefs.ear_secondary_colors = character.ear_secondary_colors // RS EDIT END (Port of VS PR#16513 'Adds a second ear slot.')
