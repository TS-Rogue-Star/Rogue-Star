...
/mob/living/proc/handle_eat_minerals(obj/item/snack, mob/living/user)
	...
	else if(istype(I, /obj/item/weapon/entrepreneur/crystal))		//Ported from VOREStation 15933
		nom = list("nutrition" = 100,  "remark" = "The crytal was particularly brittle and not difficult to break apart, but the inside was incredibly flavoursome. Though devoid of any actual healing power, it seems to be very nutritious!", "WTF" = FALSE)		//Ported from VOREStation 15933
