...
/mob/living/carbon/human/proc/shapeshifter_select_secondary_ears() // RS EDIT START (Port of VS PR#16513 'Adds a second ear slot.')
	...
	update_hair() // RS EDIT END (Port of VS PR#16513 'Adds a second ear slot.')
