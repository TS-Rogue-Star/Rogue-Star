		...
		if(do_after(src,5 SECONDS))
			...
			*/ //Check not needed?
			...
			for(var/organname in organs_by_name)
				...
				if(dna_markings)
					var/obj/item/organ/external/EO = organs_by_name[organname] //<= returns entries from an assoc list. If people are beheaded, have their limbs gibbed etc, those entries are null
					if(!EO) //Fixes runtime generated by limb missing Sari Bork 9/12/2025
						continue
