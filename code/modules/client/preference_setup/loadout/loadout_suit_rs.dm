// New Talon Suits
/datum/gear/suit/wintercoat/refreshedtalon
	display_name = "Refreshed Talon Wintercoat"
	description = "An expertly manufacted winter coat for those cold days in the pitch black vaccum of space."
	path = /obj/item/clothing/suit/storage/hooded/wintercoat/talon/refreshed
