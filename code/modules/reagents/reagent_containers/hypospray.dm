...
/obj/item/weapon/reagent_containers/hypospray/vial
	...
	name = "MKI Vial hypospray" //RS Edit
	icon_state = "advhypo"
	//desc = "A new development from DeForest Medical, this new hypospray takes 30-unit vials as the drug supply for easy swapping."
	desc = "A development from DeForest Medical, this hypospray takes 30-unit vials as the drug supply for easy swapping." //RS Edit
