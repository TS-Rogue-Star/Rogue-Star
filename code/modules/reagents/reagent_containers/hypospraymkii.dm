...
/obj/item/weapon/hypospray_mkii
	...
	//var/obj/item/weapon/reagent_containers/glass/bottle/hypovial/loadedvial
	//var/start_vial = /obj/item/weapon/reagent_containers/glass/beaker/vial
	var/obj/item/weapon/reagent_containers/glass/beaker/vial/loadedvial
	var/start_vial = /obj/item/weapon/reagent_containers/glass/beaker/vial
...
/obj/item/weapon/hypospray_mkii/brute
	start_vial = /obj/item/weapon/reagent_containers/glass/beaker/vial/preloaded/bicaridine

/obj/item/weapon/hypospray_mkii/antitoxin
	start_vial = /obj/item/weapon/reagent_containers/glass/beaker/vial/preloaded/antitoxin

/obj/item/weapon/hypospray_mkii/oxygen
	start_vial = /obj/item/weapon/reagent_containers/glass/beaker/vial/preloaded/dexalin

/obj/item/weapon/hypospray_mkii/burn
	start_vial = /obj/item/weapon/reagent_containers/glass/beaker/vial/preloaded/dermaline

/obj/item/weapon/hypospray_mkii/tricord
	start_vial = /obj/item/weapon/reagent_containers/glass/beaker/vial/preloaded/tricordrazine

/obj/item/weapon/hypospray_mkii/CMO
	name = "hypospray mk.II deluxe"
	allowed_containers = list(/obj/item/weapon/reagent_containers/glass/beaker/vial, /obj/item/weapon/reagent_containers/glass/bottle)
	icon_state = "cmo2"
	item_state = "cmo2"
	...
	start_vial = /obj/item/weapon/reagent_containers/glass/beaker/vial
...
/obj/item/weapon/hypospray_mkii/Initialize()
	...
	if(!spawnwithvial)
		...
		return
	if(start_vial)
		loadedvial = new start_vial
	update_icon()

/obj/item/weapon/hypospray_mkii/update_icon()
	..()
	icon_state = "[initial(icon_state)][loadedvial ? "" : "-e"]"
	if(ismob(loc))
		var/mob/M = loc
...
/obj/item/weapon/hypospray_mkii/proc/unload_hypo(obj/item/I, mob/user)
	if(is_type_in_list(I, allowed_containers))
		...
		user.put_in_hands(V)
		to_chat(user, span_notice("You remove [loadedvial] from [src]."))
		loadedvial = null
		update_icon()
...
/obj/item/weapon/hypospray_mkii/attackby(obj/item/I, mob/living/user)
	if(is_type_in_list(I, allowed_containers) && loadedvial != null)
		if(!quickload)
		...
		loadedvial = V
		user.visible_message(span_notice("[user] has loaded a vial into [src]."),span_notice("You have loaded [loadedvial] into [src]."))
		update_icon()
...
/obj/item/weapon/hypospray_mkii/afterattack(atom/target, mob/user, proximity)
	if(!loadedvial || !proximity || !isliving(target))
		return
	...
	var/contained = loadedvial.reagentlist()
	if(!loadedvial)
		to_chat(user, span_notice("[src] doesn't have any vial installed!"))
		return
	if(!loadedvial.reagents.total_volume)
...
/*/obj/item/weapon/reagent_containers/glass/beaker/vial/New()
	..()
...
/obj/item/weapon/reagent_containers/glass/bottle/hypovial/large/preloaded/CMO
	...
	prefill = list("inaprovaline" = 10, "dermaline" = 10, "anti_toxin" = 10, "tramadol" = 10, "bicaridine" = 10, "dexalinp" = 10)

/obj/item/weapon/reagent_containers/glass/bottle/hypovial/large/preloaded/combat
	name = "large vial (Combat Mix)"
	icon_state = "hypoviallarge-cmos"
	prefill = list("bicaridine" = 10, "dermaline" = 10, "dermaline" = 10, "oxycodone" = 10, "inaprovaline" = 10, "tricordrazine" = 10)
