...
/obj/item/weapon/gun/energy/robotic/proc/gun_flag_check(var/flag_to_check) //Checks for the flag of the gun.
	return (borg_flags & flag_to_check)

/obj/item/weapon/melee/robotic/proc/weapon_flag_check(var/flag_to_check) //Checks for the flag of the gun.
	return (borg_flags & flag_to_check)

/// The base gun types. Build off these four.
/obj/item/weapon/gun/energy/robotic
	name = "Cybernetic Gun"
...
/obj/item/weapon/gun/energy/robotic/laser
	borg_flags = COUNTS_AS_ROBOT_GUN | COUNTS_AS_ROBOT_LASER
	projectile_type = /obj/item/projectile/beam

/obj/item/weapon/gun/energy/robotic/taser
...
/obj/item/weapon/gun/energy/robotic/disabler
...
/// Tasers
/obj/item/weapon/gun/energy/robotic/taser/xeno
	name = "xeno taser gun"
...
/obj/item/weapon/gun/energy/robotic/taser/swarm
	name = "disabler"
...
/// Lasers
/obj/item/weapon/gun/energy/robotic/laser/retro
	name = "retro laser"
	icon_state = "retro"
	item_state = "retro"
...
/obj/item/weapon/gun/energy/robotic/laser/rifle
...
/obj/item/weapon/gun/energy/robotic/laser/heavy
...
/obj/item/weapon/gun/energy/robotic/laser/dakkalaser
	...
	cell_type = /obj/item/weapon/cell/device/weapon/recharge //This one doesn't use borg power, it has it's own power cell. I don't know why, but I'm not here to balance/unbalance it.
...
/obj/item/weapon/melee/robotic //Just the parent. Don't use this one.
...
/obj/item/weapon/melee/robotic/jaws
	icon = 'icons/mob/dogborg_vr.dmi'
...
/obj/item/weapon/melee/robotic/jaws/big
	name = "combat jaws"
	icon_state = "jaws"
...
/obj/item/weapon/melee/robotic/jaws/small
	name = "puppy jaws"
	...
	var/emagged = 0
/obj/item/weapon/melee/robotic/jaws/small/attack_self(mob/user)
...
/obj/item/weapon/melee/robotic/borg_combat_shocker
	name = "combat shocker"
	icon = 'icons/mob/dogborg_vr.dmi'
...
/obj/item/weapon/melee/robotic/borg_combat_shocker/apply_hit_effect(mob/living/target, mob/living/user, var/hit_zone)
	if(isrobot(target))
		return ..()
...
/obj/item/weapon/melee/robotic/dagger
	name = "Robotic Dagger"
...
/obj/item/weapon/melee/robotic/blade //For downstreams that use blade
	name = "Robotic Blade"
